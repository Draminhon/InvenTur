...
class ContainerWidget extends StatelessWidget{
   ...
   final codIBGE;
         ...
         const ContainerWidget(this.codIBGE, this.estado, this.municipio, this.dataI, this.dataT, this.qtdeL, this.qtdeP);
  ...
  Widget build(BuildContext context) {
   ...
   Container( 
    padding: EdgeInsets.only(left: sizeScreen.width * 0.03, top: sizeScreen.height * 0.03),
          ...
          RichText(text: TextSpan(text:  'Código IBGE do município: $codIBGE\n'
          'Estado: $estado\n'
          'Município: $municipio\n'
        ...
        , style: TextStyle(fontSize: sizeScreen.height * 0.02, fontWeight: FontWeight.w500, color: Colors.black, height: sizeScreen.height * 0.002),),
          ),
          
          Padding(padding: EdgeInsets.only(left: sizeScreen.width * 0.7), child: 
           SizedBox(
