...
class InformacaoBasicaDoMunicipio(Base):
    ...
    enderecoPrefeitura = models.CharField(max_length=255)
    bairroPrefeitura = models.CharField(max_length=255)
    cepPrefeitura = models.CharField(max_length=255)
    numeroPrefeitura = models.CharField(max_length=255)
    instagramPrefeitura = models.CharField(max_length=255)
    emailPrefeitura = models.CharField(max_length=255)
    sitePrefeitura = models.CharField(max_length=255)
    cnpjPrefeitura = models.CharField(max_length=255)
    latitudePrefeitura = models.CharField(max_length=255)
    longitudePrefeitura = models.CharField(max_length=255)
    municipiosLimitrofes = models.CharField(max_length=255)
    distanciaDaCapital = models.CharField(max_length=255)
    totalFuncionariosPrefeitura = models.CharField(max_length=255)
    pessoasComDeficienciaPrefeitura = models.CharField(max_length=255)
    nomeDoPrefeito = models.CharField(max_length=255)
    nomeDasSecretariasEtc = models.CharField(max_length=255)
    nomeOrgaoOficialTurismo = models.CharField(max_length=255)
    enderecoOrgaoOfcTurismo = models.CharField(max_length=255)
    avenidaRuaOfcTurismo = models.CharField(max_length=255)
    distritoOrgaoOfcTurismo = models.CharField(max_length=255)
    cepOrgaoOfcTurismo = models.CharField(max_length=255)
    numeroOrgaoOfcTurismo = models.CharField(max_length=255)
    instagramOrgaoOfcTurismo = models.CharField(max_length=255)
    siteOrgaoOfcTurismo = models.CharField(max_length=255)
    emailOrgaoOfcTurismo = models.CharField(max_length=255)
    qtdeFuncionariosOrgaoOfcTurismo = models.CharField(max_length=255)
    qtdeFormacaoSuperiorEmTurismoOrgaoOfcturismo = models.CharField(max_length=255)
    instanciaGovernancaMunicipal = models.CharField(max_length=255)
    instanciaGovernancaEstadual = models.CharField(max_length=255)
    instanciaGovernancaRegional = models.CharField(max_length=255)
    instanciaGovernancaNacional = models.CharField(max_length=255)
    instanciaGovernancaInternacional = models.CharField(max_length=255)
    instanciaGovernancaOutras = models.CharField(max_length=255)
    aniversarioMunicipio = models.CharField(max_length=255)
    santoPadroeiro = models.CharField(max_length=255)
    diaDoSantoPadroeiro = models.CharField(max_length=255)
    feriadoMunicipal01 = models.CharField(max_length=255)
    dataFeriadoMunicipal01 = models.CharField(max_length=255)
    feriadoMunicipal02 = models.CharField(max_length=255)
    dataFeriadoMunicipal02 = models.CharField(max_length=255)
    feriadoMunicipal03 = models.CharField(max_length=255)
    dataFeriadoMunicipal03 =models.CharField(max_length=255)
    origemDoNome =models.CharField(max_length=255)
    dataFundacao = models.CharField(max_length=255)
    dataEmancipacao = models.CharField(max_length=255)
    fundadores = models.CharField(max_length=255)
    outrosFatosDeImportanciaHistorica = models.CharField(max_length=255)

    areaTotalMunicipio = models.CharField(max_length=255)
    areaUrbana = models.CharField(max_length=255)
    areaRural = models.CharField(max_length=255)
    anoBase = models.CharField(max_length=255)
    populacaoTotal = models.CharField(max_length=255)
    populacaoUrbana = models.CharField(max_length=255)
    populacaoRural = models.CharField(max_length=255)
    anoBasePopulacao = models.CharField(max_length=255)
    temperaturaMedia = models.CharField(max_length=255)
    temperaturaMinima = models.CharField(max_length=255)
    temperaturaMaxima = models.CharField(max_length=255)
    altitudeMedia = models.CharField(max_length=255)
    qtdeDomiciliosAtendidos = models.CharField(max_length=255)
    empresaResponsavel = models.CharField(max_length=255)
    esgotoTotalAtendidos = models.CharField(max_length=255)
    esgotoDomiciliosAtendidos = models.CharField(max_length=255)
    esgotoRuraisAtendidos = models.CharField(max_length=255)
    esgotoEntidadeResponsavel = models.CharField(max_length=255)
    fossaSepticaTotalAtendidos = models.CharField(max_length=255)
    fossaSepticaDomiciliosAtendidos = models.CharField(max_length=255)
    fossaSepticaRuraisAtendidos = models.CharField(max_length=255)
    fossaSepticaEntidadeResponsavel = models.CharField(max_length=255)
    fossaRudimentarTotalAtendidos = models.CharField(max_length=255)
    fossaRudimentarDomiciliosAtendidos = models.CharField(max_length=255)
    fossaRudimentarRuraisAtendidos = models.CharField(max_length=255)
    fossaRudimentarEntidadeResponsavel = models.CharField(max_length=255)
    valaTotalAtendidos = models.CharField(max_length=255)
    valaDomiciliosAtendidos = models.CharField(max_length=255)
    valaRuraisAtendidos = models.CharField(max_length=255)
    valaEntidadeResponsavel = models.CharField(max_length=255)
    estacaoDeTratamentoTotalAtendidos = models.CharField(max_length=255)
    estacaoDeTratamentoDomiciliosAtendidos  = models.CharField(max_length=255)
    estacaoDeTratamentoRuraisAtendidos = models.CharField(max_length=255)
    estacaoDeTratamentoEntidadeResponsavel  = models.CharField(max_length=255)
    esgotoTratadoTotalAtendidos = models.CharField(max_length=255)
    esgotoTratadoDomiciliosAtendidos = models.CharField(max_length=255)
    esgotoTratadoRuraisAtendidos = models.CharField(max_length=255)
    esgotoTratadoEntidadeResponsavel = models.CharField(max_length=255)
    servicoDeEsgotoOutroTotalNome = models.CharField(max_length=255)
    servicoDeEsgotoOutroTotalAtendidos = models.CharField(max_length=255)
    servicoDeEsgotoOutroDomiciliosAtendidos = models.CharField(max_length=255)
    servicoDeEsgotoOutroRuraisAtendidos = models.CharField(max_length=255)
    servicoDeEsgotoOutroEntidadeResponsavel = models.CharField(max_length=255)
    capacidadeEmKVA = models.CharField(max_length=255)
    geradorDeEmergenciaCapacidadeEmKVA = models.CharField(max_length=255)
    redeUrbanaTotalAbastecido = models.CharField(max_length=255)
    redeUrbanaEntidadeResponsavel = models.CharField(max_length=255)
    redeRuralTotalAbastecido  = models.CharField(max_length=255)
    redeRuralEntidadeResponsavel  = models.CharField(max_length=255)
    abastecimentoProprioTotalAtendidos = models.CharField(max_length=255)
    abastecimentoProprioDomiciliosAtendidos = models.CharField(max_length=255)
    abastecimentoProprioRuraisAtendidos = models.CharField(max_length=255)
    abastecimentoProprioEntidadeResponsavel = models.CharField(max_length=255)

    servicosDeEnergiaOutroTotalNome = models.CharField(max_length=255)
    servicosDeEnergiaOutroTotalAtendidos  = models.CharField(max_length=255)
    servicosDeEnergiaOutroDomiciliosAtendidos  = models.CharField(max_length=255)
    servicosDeEnergiaOutroEntidadeResponsavel  = models.CharField(max_length=255)
    coletaSeletivaTotalAtendidos  = models.CharField(max_length=255)
    coletaSeletivaDomiciliosAtendidos  = models.CharField(max_length=255)
    coletaSeletivaRuraisAtendidos  = models.CharField(max_length=255)
    coletaSeletivaEntidadeResponsavel  = models.CharField(max_length=255)
    coletaNaoSeletivaTotalAtendidos  = models.CharField(max_length=255)
    coletaNaoSeletivaDomiciliosAtendidos  = models.CharField(max_length=255)
    coletaNaoSeletivaRuraisAtendidos  = models.CharField(max_length=255)
    coletaNaoSeletivaEntidadeResponsavel  = models.CharField(max_length=255)
    coletaSemColetaTotal  = models.CharField(max_length=255)
    coletaSemColetaDomicilios  = models.CharField(max_length=255)
    coletaSemColetaRurais  = models.CharField(max_length=255)
    deposicaoAterroSanitarioTotalAtendidos  = models.CharField(max_length=255)
    deposicaoAterroSanitarioDomiciliosAtendidos  = models.CharField(max_length=255)
    deposicaoAterroSanitarioRuraisAtendidos  = models.CharField(max_length=255)
    deposicaoAterroSanitarioEntidadeResponsavel  = models.CharField(max_length=255)
    deposicaoACeuAbertoTotalAtendidos  = models.CharField(max_length=255)
    deposicaoACeuAbertoDomiciliosAtendidos = models.CharField(max_length=255)
    deposicaoACeuAbertoRuraisAtendidos  = models.CharField(max_length=255)
    deposicaoACeuAbertoEntidadeResponsavel  = models.CharField(max_length=255)
    deposicaoOutroTotalNome  = models.CharField(max_length=255)
    deposicaoOutroTotalAtendidos  = models.CharField(max_length=255)
    deposicaoOutroDomiciliosAtendidos  = models.CharField(max_length=255)
    deposicaoOutroEntidadeResponsavel  = models.CharField(max_length=255)
    reciclagemDeAcoTotalReciclado  = models.CharField(max_length=255)
    reciclagemDeAcoEntidadeResponsavel  = models.CharField(max_length=255)
    reciclagemDeAluminioTotalReciclado  = models.CharField(max_length=255)
    reciclagemDeAluminioEntidadeResponsavel  = models.CharField(max_length=255)
    reciclagemDeFerroTotalReciclado  = models.CharField(max_length=255)
    reciclagemDeFerroEntidadeResponsavel  = models.CharField(max_length=255)
    reciclagemOutroNome  = models.CharField(max_length=255)
    reciclagemOutroTotalReciclado  = models.CharField(max_length=255)
    reciclagemOutroEntidadeResponsavel  = models.CharField(max_length=255)
    reciclagemDeBateriasPilhasTotalReciclado  = models.CharField(max_length=255)
    reciclagemDeBateriasPilhasEntidadeResponsavel = models.CharField(max_length=255)
    reciclagemDeBorrachaTotalReciclado  = models.CharField(max_length=255)
    reciclagemDeBorrachaEntidadeResponsavel  = models.CharField(max_length=255)
    reciclagemDeEletronicosTotalReciclado  = models.CharField(max_length=255)
    reciclagemDeEletronicosEntidadeResponsavel = models.CharField(max_length=255)
    reciclagemDeEmbalagensLongaVidaTotalReciclado  = models.CharField(max_length=255)
    reciclagemDeEmbalagensLongaVidaEntidadeResponsavel  = models.CharField(max_length=255)
    reciclagemDeEntulhoTotalReciclado  = models.CharField(max_length=255)
    reciclagemDeEntulhoEntidadeResponsavel  = models.CharField(max_length=255)
    reciclagemDeMadeiraTotalReciclado = models.CharField(max_length=255)
    reciclagemDeMadeiraEntidadeResponsavel  = models.CharField(max_length=255)
    reciclagemDePapelTotalReciclado = models.CharField(max_length=255)
    reciclagemDePapelEntidadeResponsavel  = models.CharField(max_length=255)
    reciclagemDePlasticoEEmbalagensTotalReciclado  = models.CharField(max_length=255)
    reciclagemDePlasticoEEmbalagensEntidadeResponsavel = models.CharField(max_length=255)
    reciclagemDeVidroTotalReciclado  = models.CharField(max_length=255)
    reciclagemDeVidroEntidadeResponsavel  = models.CharField(max_length=255)
    reciclagemDeOleoDeCozinhaTotalReciclado  = models.CharField(max_length=255)
    reciclagemDeOleoDeCozinhaEntidadeResponsavel = models.CharField(max_length=255)
    reciclagemOutrosNome  = models.CharField(max_length=255)
    reciclagemOutrosTotalReciclado  = models.CharField(max_length=255)
    reciclagemOutrosEntidadeResponsavel  = models.CharField(max_length=255)
    divulgacaoImpressaFolder  = models.CharField(max_length=255)
    divulgacaoImpressaRevista  = models.CharField(max_length=255)
    divulgacaoImpressaJornal  = models.CharField(max_length=255)
    divulgacaoImpressaOutros  = models.CharField(max_length=255)
    visitantesAno  = models.CharField(max_length=255)
    visitantesAnoAltaTemporada  = models.CharField(max_length=255)
    origemInternacionalAnoBase  = models.CharField(max_length=255)
    atrativosMaisVisitados = models.CharField(max_length=255)
    redeDeEsgoto = models.CharField(max_length=255)
    fossaSeptica  = models.CharField(max_length=255)
    fossaRudimentar  = models.CharField(max_length=255)
    vala  = models.CharField(max_length=255)
    estacaoDeTratamento = models.CharField(max_length=255)
    esgotoTratado  = models.CharField(max_length=255)
    servicoDeEsgotoOutros = models.CharField(max_length=255)
    geradorDeEmergencia  = models.CharField(max_length=255)
    redeUrbana  = models.CharField(max_length=255)
    redeRural  = models.CharField(max_length=255)
    abastecimentoProprio = models.CharField(max_length=255)
    servicosDeEnergiaOutro = models.CharField(max_length=255)
    coletaSeletiva = models.CharField(max_length=255)
    coletaNaoSeletiva = models.CharField(max_length=255)
    coletaSemColeta  = models.CharField(max_length=255)
    deposicaoAterroSanitario = models.CharField(max_length=255)
    deposicaoCompostagem  = models.CharField(max_length=255)
    deposicaoACeuAberto  = models.CharField(max_length=255)
    deposicaoOutro  = models.CharField(max_length=255)
    reciclagemDeAco  = models.CharField(max_length=255)
    reciclagemDeAluminio = models.CharField(max_length=255)
    reciclagemDeFerro  = models.CharField(max_length=255)
    reciclagemOutro  = models.CharField(max_length=255)
    reciclagemDeBateriasPilhas = models.CharField(max_length=255)
    reciclagemDeBorracha  = models.CharField(max_length=255)
    reciclagemDeEletronicos = models.CharField(max_length=255)
    reciclagemDeEmbalagensLongaVida = models.CharField(max_length=255)
    reciclagemDeEntulho  = models.CharField(max_length=255)
    reciclagemDeMadeira  = models.CharField(max_length=255)
    reciclagemDePapel  = models.CharField(max_length=255)
    reciclagemDePlasticoEEmbalagens = models.CharField(max_length=255)
    reciclagemDeVidro = models.CharField(max_length=255)
    reciclagemDeOleoDeCozinha  = models.CharField(max_length=255)
    reciclagemOutros  = models.CharField(max_length=255)
    servicosDeComunicacaoTelefoniaMovel  = models.CharField(max_length=255)
    servicosDeComunicacaoTelefoniaFixa  = models.CharField(max_length=255)
    promocaoTuristicaDivulgacaoImpressa  = models.CharField(max_length=255)
    promocaoTuristicaDivulgacaoTelevisiva  = models.CharField(max_length=255)
    mesesMaisFrios = models.JSONField()
    mesesMaisQuentes  = models.JSONField()
    mesesMaisChuvosos  = models.JSONField()
    mesesMenosChuvosos  = models.JSONField()
    tipoDeAbastecimento  = models.CharField(max_length=255)
    energiaEletrica  = models.CharField(max_length=255)
    servicosDeComunicacaoAcessoAInternet  = models.CharField(max_length=255)
    atendimentoEmLinguaEstrangeira  = models.CharField(max_length=255)
    atendimentoAoVisitanteInformativosImpressos  = models.CharField(max_length=255)
    mesesAltaTemporada  = models.JSONField()
    origemDosVisitantesTuristas  = models.JSONField()
    origemNacional  = models.JSONField()
    origemInternacional  = models.JSONField()
    segmentosTurismoEspecializado  = models.JSONField()
    leiOrganica   = models.CharField(max_length=255)
    ocupacaoDoSolo  = models.CharField(max_length=255)
    planoDeDesenvolvimentoDoTurismo   = models.CharField(max_length=255)
    protecaoAmbiental  = models.CharField(max_length=255)
    apoioACultura   = models.CharField(max_length=255)
    incentivosFiscaisAoTurismo   = models.CharField(max_length=255)
    planoDiretor = models.CharField(max_length=255)
    fundoMunicipalDeTurismo  = models.CharField(max_length=255)
    legislacaoOutras  = models.CharField(max_length=255)