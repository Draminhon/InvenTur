  ...
  group(
    ...
    () {
      ...
      test(
        ...
        () {
          final result = nameValidator.validate(
            name: 'Texto para teste de validação de tamanho maximo. Texto para teste de validação de tamanho maximo. Texto para teste de validação de tamanho maximo. Texto para teste de validação de tamanho maximo. Texto para teste de validação de tamanho maximo. Texto para teste de validação de tamanho maximo.'
          );

          expect(result, equals('O nome deve possuir no máximo 250 caracteres'));
        },
      );
      test(
