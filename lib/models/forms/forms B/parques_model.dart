class ParquesModel {
  ...
  String? areaTotalDoEstabelecimento;
  ...
  String? entradaPaga;
  List<String>? outrosEquipamentosEEspacos;
  ...
  ParquesModel({
    ...
    this.municipio,
    this.tipo,
    this.areaTotalDoEstabelecimento,
    this.ambientacaoTematica,
    this.outrosEquipamentosEEspacos,
    this.observacoes,
    this.referencias,
  ...
  Map<String, dynamic> toMap() {
    ...
    'entidadeManetedoraSite' : entidadeManetedoraSite,
      ...
      'areaTotalDoEstabelecimento' : areaTotalDoEstabelecimento,
    'ambientacaoTematica' : ambientacaoTematica,
      ...
      'outrosEquipamentosEEspacos': outrosEquipamentosEEspacos,
    };
  }
  ...
  ParquesModel.fromJson(Map<String, dynamic> json) {
    ...
    areaTotalDoEstabelecimento = json['areaTotalDoEstabelecimento'];
    ...
    outrosEquipamentosEEspacos = List<String>.from(json['outrosEquipamentosEEspacos'] ?? []);
