...
void dispose() {
  ...
  Widget build(BuildContext context) {
    ...
    Future<void> sendForm(Map<String, dynamic> valoresjson) async{
      ...
      final url = Uri.parse('http://10.0.2.2:8000/api/v1/rodovias/');
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      ...
                      valoresjson['tipo_de_organizacao_instituicao'] = selectedValuesStr;
                      valoresjson['posto_de_combustivel'] = postoStr;
                      valoresjson['outros_servicos'] = outrosServicosStr;
                      valoresjson['estruturas_ao_longo_da_via'] = estruturasStr;
                      autoFillForm();
