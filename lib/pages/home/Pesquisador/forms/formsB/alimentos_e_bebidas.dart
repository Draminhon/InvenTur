...
class _AlimentoseBebidasState extends State<AlimentoseBebidas> {
  ...
  void autoFillForm() {
    ...
    fillIfExists('outras distancias nome', 'Nome das Outras Distâncias Exemplo');
          fillIfExists('outras regras e informações', 'Informações adicionais e regras');
                  ...
                  children: [
                    ...
                    SizedBox(
                        ...
                        child: CustomTextField(
                          ...
                          name: '(km)',
                          getValue: (newValue) {
                            valoresjson['DistanciaEstaçãoMaritima'] = newValue;
                          },
                          validat: (value) {
                            return null;
                          },
            ...
            setState(() {
              valoresjson['tabelasHorario'] = p0;
                ...
                Padding(
                  ...
                  child: CustomTextField(
                    controller: getController('instaladas pessoas atendidas sentadas'),
                    validat: (value) {
                      if (value == null || value.isEmpty) {
                        return 'Preencha o campo';
                      }
                ...
                Padding(
                  padding: EdgeInsets.only(left: 100.w, right: 50.w),
                  child: CustomTextField(
                    controller: getController('simultanea pessoas atendidas sentadas'),
                    validat: (value) {
                      if (value == null || value.isEmpty) {
                        return 'Preencha o campo';
                      }
                  ...
                  Row(
                    children: [
                      ...
                      SizedBox(
                          ...
                          //height: sizeScreen.height * 0.07,
                          child: CustomTextField(
                            controller: getController('capacidade de veículos'),
                              validat: (value) {
                                if (value == null || value.isEmpty) {
                                  return 'Preencha o campo';
                                }
                      ...
                      SizedBox(
                          ...
                          child: CustomTextField(
                            controller: getController('numero automoveis'),
                              ...
                              name: '',
                              getValue: (newValue) {
                                valoresjson['numeroAutomoveisº'] = newValue;
                              }))
                    ],
                  ),
                  SizedBox(
               ...
               CheckC(
                  onChanged: (p0) => valoresjson['especificacaoDaGastronomiaPorPais'] = p0,
                  nomes: [
                    'Não',
                    'Argentina',
                    'Coreana',
                ...
                SizedBox(
                 ...
                 CheckC(
                  onChanged: (p0) => valoresjson['seForBrasileiraPorRegiao'] = p0,
                  nomes: [
                    'Não',
                    'Amazônica',
                    'Campeira gaúcha',
  ...
  valoresjson['tabelaEquipamentoEEspaco'] = p0;
                ...
                RadioD(
                  ...
                  getValue: (newValue) {
                    valoresjson['EstadoGeralDeConservação'] = newValue;
                  },
                ),
                SizedBox(
                  height: sizeScreen.height * 0.05,
                ...
                Padding(
                 ...
                 CheckC(
                  onChanged: (p0) {
                      valoresjson['areaDeCirculacaoAcessoInternoParaCadeiraDeRodas'] = p0;    
                  },
                  nomes: [
                    'Não',
                    'Rampa',
                ...
                Padding(
                 ...
                 CheckC(
                  onChanged: (p0) {
                     valoresjson['equipamentoMotorizadoParaDeslocamentoInterno'] = p0;
                  },
                  nomes: [
                    'Não',
                    'Cadeira',
...
debugPrint(jsonEncode(valoresjson['tabelaEquipamentoEEspaco']), wrapWidth: 1024);
